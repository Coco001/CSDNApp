...
public class NewContentAdapter extends BaseAdapter {
    ...
    public NewContentAdapter(Context context) {
        ...
        options = new DisplayImageOptions.Builder().showStubImage(R.mipmap.images)
                .showImageForEmptyUri(R.mipmap.images).showImageOnFail(R.mipmap.images).cacheInMemory()
